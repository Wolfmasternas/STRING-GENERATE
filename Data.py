...
You can use me to generate pyrogram and telethon string session. Use the below buttons to know more!
    ...
    buttons = [
        [InlineKeyboardButton("🔥 Start Generating Session 🔥", callback_data="generate")],
        [InlineKeyboardButton("👨‍💻 Repo 👨‍💻", url="https://github.com/Wolfmasternas/STRING-GENERATE")],
        [
            InlineKeyboardButton("How to Use ❔", callback_data="help"),
            InlineKeyboardButton(" About", callback_data="about")
        ],
        [InlineKeyboardButton("🇮🇳 Owner 🇮🇳", url="https://t.me/wolfmasterxd")],
    ]
